...
//conditon to know the button is clicked
                ...
                <h3 class="text-center mb-4">MyTumblr Login</h3>
                    ...
                    <div class="form-group">
                      ...
                      if(isset($_REQUEST['notexist'])===true){
                          ...
                          echo "<div class='alert alert-warning' role='alert'> You are still looged in. Please <a href='account.php'> click here </a> to oproceed.  </div>";
                      }
